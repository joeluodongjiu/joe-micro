...
func TestRequired(t *testing.T) {
	...
	testMap := []struct {
		...
		{map[string]string{"code": "aa", "b": "bb"}, true},
...
func TestIn(t *testing.T) {
	validator := New()
	testIn1 := []struct {
		param    map[string]string `validate:"in=code,b,c"`
		expected bool
	}{
		{map[string]string{"k1": "code", "k2": "c"}, true},
		{map[string]string{"k1": "code", "k2": "d"}, false},
		{map[string]string{}, false},
	}
	...
	testIn4 := []struct {
		param    string `validate:"in=code,b,c"`
		expected bool
	}{
		{"code", true},
		{"d", false},
...
func TestUnique(t *testing.T) {
	...
	testUnique1 := []struct {
		...
		{[]string{"code", "b", "c", "d", "e"}, true},
		{[]string{"code", "b", "c", "d", "code"}, false},
	}
	...
	testUnique2 := []struct {
		...
		{[]uniqT{{"code"}, uniqT{"b"}, uniqT{"c"}, uniqT{"d"}, uniqT{"e"}}, true},
		{[]uniqT{{"code"}, uniqT{"b"}, uniqT{"c"}, uniqT{"d"}, uniqT{"code"}}, false},
	}
