...
func (self *myValidator) SetTag(tag string) *myValidator {
	self.tagName = tag
	return self
}

func (self *myValidator) SetTitleTag(titleTag string) *myValidator {
	self.TitleTag = titleTag
	return self
}

func (self *myValidator) SetSkipOnStructEmpty(skip bool) *myValidator {
	self.skipOnStructEmpty = skip
	return self
}

func (self *myValidator) SetValidatorSplit(str string) *myValidator {
	self.validatorSplit = str
	return self
}

func (self *myValidator) SetValidator(validatorK string, validator interface{}) *myValidator {
	self.validator[validatorK] = validator
	return self
}

func (self *myValidator) SetValidators(validatorMap map[string]interface{}) *myValidator {
...
func (self *myValidator) LazyValidate(s interface{}) (err error) {
	syncMap := &sync.Map{}
	parentKey := "validate"
...
func (self *myValidator) Validate(s interface{}) (err []error) {
	syncMap := &sync.Map{}
	parentKey := "validate"
...
func (self *myValidator) validate(s interface{}, lazyFlag bool, syncMap *sync.Map, parentKey string) (returnErr []error) {
	var errArr []error
...
//根据 tag 申请验证器进行验证
func (self *myValidator) validateValueFromTag(tag string, lazyFlag bool, fieldTypeInfo reflect.StructField, fieldInfo reflect.Value, syncMap *sync.Map, parentKey string) (returnErr []error) {
